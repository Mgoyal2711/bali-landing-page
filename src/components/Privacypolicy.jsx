import { ShieldCheck, Lock, UserRound, Monitor, Database, Shield, Globe, Baby } from "lucide-react";
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          ...
          <div className="max-w-4xl text-center text-white">
            ...
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-5 py-2 text-sm font-semibold backdrop-blur-xl">
      ...
      <section className="px-4 py-10">
        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="rounded-[28px] bg-white p-5 shadow-lg">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h2 className="text-2xl font-extrabold text-[#072B4F]">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            {/* PERSONAL INFO */}
            <div className="rounded-[28px] bg-white p-6 shadow-lg transition hover:-translate-y-1">
              ...
              <div className="mb-5 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold uppercase tracking-[3px] text-cyan-700">
                    Information
                  </p>

                  <h3 className="text-2xl font-extrabold text-[#072B4F]">
          ...
          <div className="rounded-[28px] bg-white p-6 shadow-lg">
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div>
                ...
                <h2 className="text-3xl font-extrabold text-[#072B4F]">
          ...
          {/* FOOTER CTA */}
          <footer className="mt-10 rounded-[28px] bg-[#072B4F] px-4 py-10 text-center text-white">
            ...
            <div className="mt-6">
              ...
              <Link
                to="/"
                className="inline-flex rounded-full bg-[#EAB308] px-6 py-3 text-sm font-bold text-black transition hover:scale-105"
              >
                Back To Home
              </Link>
